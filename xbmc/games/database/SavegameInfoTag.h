...
class CSavegameInfoTag : public IArchivable, public ISerializable, public ISortable, public IDBInfoTag
{
public:
  ...
  const CSavegameInfoTag& operator=(const CSavegameInfoTag& item);
